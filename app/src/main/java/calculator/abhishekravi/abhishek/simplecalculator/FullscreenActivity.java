package calculator.abhishekravi.abhishek.simplecalculator;

import calculator.abhishekravi.abhishek.simplecalculator.util.SystemUiHider;
...
public class FullscreenActivity extends Activity {
    public static boolean debounce = true;
    // final TextView v = (TextView)findViewById(R.id.button3);
    ...
    public void onClick(View v)
    {
        if(debounce != false)
        {
            if(errorCheck()) {
                ...
                sumofn = n1 + n2;
                t.setText(Double.toString(sumofn));
                debounce = true;
            }
            else
            {
    ...
    public void clear(View v)
    {
        if(debounce != false) {
            debounce = false;
            TextView textAnswer1 = (TextView) findViewById(R.id.sum);
            TextView textNum1 = (TextView) findViewById(R.id.num1);
            TextView textNum2 = (TextView) findViewById(R.id.num2);
            textNum1.setText(" ");
            textNum2.setText(" ");
            textAnswer1.setText(" ");
            debounce = true;
